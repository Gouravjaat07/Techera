...
// ════════════════════════════════════════════════════════════
//  TEAM DATA  (equivalent of TeamData.js)
// ════════════════════════════════════════════════════════════
...
const founders = [
  {
    ...
    github: "#",
    color: "#00EEFF",
    skills: ["React", "Node.js", "Community"],
  },
  {
    id: "f2",
    name: "Priya Sharma",
  ...
  },
  {
    ...
    initials: "RV",
    tag: "Co-Founder",
    bio: "Open-source contributor building scalable backend systems that power TechEra's ecosystem.",
    linkedin: "#",
    github: "#",
    color: "#06B6D4",
...
const departments = [
  {
    ...
    description:
      "Building the digital backbone of TechEra — from the website to internal tools and automation.",
    lead: {
      id: "t1", name: "Kabir Nair", role: "Tech Lead", initials: "KN",
      linkedin: "#", github: "#", skills: ["React", "TypeScript", "AWS"],
    },
    coLead: {
      id: "t2", name: "Sneha Joshi", role: "Co-Lead", initials: "SJ",
      linkedin: "#", github: "#", skills: ["Vue.js", "MongoDB", "Docker"],
    },
    members: [
  ...
  },
  {
    ...
    description:
      "Crafting TechEra's visual identity through graphics, motion design, and brand storytelling.",
    lead: {
      id: "d1", name: "Nisha Kapoor", role: "Design Lead", initials: "NK",
      linkedin: "#", github: "#", skills: ["Figma", "After Effects", "Brand"],
    },
    coLead: {
      id: "d2", name: "Arjun Das", role: "Co-Lead", initials: "AD",
      linkedin: "#", github: "#", skills: ["Illustrator", "Motion", "3D"],
    },
    members: [
  ...
  },
  {
    ...
    description:
      "Orchestrating hackathons, workshops, and community meetups that bring members together.",
    lead: {
      id: "e1", name: "Simran Kaur", role: "Events Lead", initials: "SK",
      linkedin: "#", github: "#", skills: ["Event Mgmt", "Logistics", "Ops"],
    },
    coLead: {
      id: "e2", name: "Aarav Shah", role: "Co-Lead", initials: "AS",
      linkedin: "#", github: "#", skills: ["Planning", "Marketing", "Budgeting"],
    },
    members: [
  ...
  },
  {
    ...
    description:
      "Amplifying TechEra's voice across platforms, growing reach and community engagement.",
    lead: {
      id: "m1", name: "Zara Qureshi", role: "Marketing Lead", initials: "ZQ",
      linkedin: "#", github: "#", skills: ["Content", "SEO", "Analytics"],
    },
    coLead: {
      id: "m2", name: "Nikhil Bose", role: "Co-Lead", initials: "NB",
      linkedin: "#", github: "#", skills: ["Social Media", "Ads", "Reels"],
    },
    members: [
  ...
  },
  {
    ...
    description:
      "Building bridges with organizations, colleges, and industry partners for mutual growth.",
    lead: {
      id: "c1", name: "Dhruv Jain", role: "Collab Lead", initials: "DJ",
      linkedin: "#", github: "#", skills: ["Networking", "BD", "Partnerships"],
    },
    coLead: {
      id: "c2", name: "Lavanya R.", role: "Co-Lead", initials: "LR",
      linkedin: "#", github: "#", skills: ["Communication", "Strategy", "Outreach"],
    },
    members: [
  ...
  },
  {
    ...
    description:
      "Writing, curating, and publishing technical articles, project showcases, and community stories.",
    lead: {
      id: "b1", name: "Aditi Sharma", role: "Content Lead", initials: "AS",
      linkedin: "#", github: "#", skills: ["Writing", "Research", "SEO"],
    },
    coLead: {
      id: "b2", name: "Kunal Roy", role: "Co-Lead", initials: "KR",
      linkedin: "#", github: "#", skills: ["Tech Writing", "Editing", "WordPress"],
    },
    members: [
...
const GLOBAL_CSS = `
  @import url('https://fonts.googleapis.com/css2?family=Syne:wght@600;700;800&family=DM+Sans:wght@300;400;500;600&family=JetBrains+Mono:wght@400;600;700&display=swap');

  .te-page { font-family: 'DM Sans', sans-serif; background: #050D1A; color: white; min-height: 100vh; overflow-x: hidden; -webkit-font-smoothing: antialiased; }
  ...
  .te-glass:hover { border-color:rgba(0,238,255,.14); }
  ...
  .te-nav-link { color:#64748B; text-decoration:none; font-size:14px; padding:8px 14px; border-radius:10px; transition:all .2s; font-family:'DM Sans',sans-serif; }
  .te-nav-link:hover { color:white; background:rgba(255,255,255,.05); }
  .te-nav-link.active { color:#00EEFF; }
  ...
  .te-scroll::-webkit-scrollbar { width:0; height:0; }
`;
...
function Avatar({ initials, color, size = 48 }) {
  return (
    <div style={{
      ...
      <span className="te-mono" style={{ fontSize: size * 0.3, fontWeight: 800, color }}>
        {initials}
      </span>
    </div>
  );
...
function Pill({ text, color }) {
  return (
    <span className="te-mono" style={{
      padding: "3px 10px", borderRadius: 999, fontSize: 10, fontWeight: 700,
      color, border: `1px solid ${color}28`, background: `${color}10`,
...
function SkillTag({ text }) {
  return (
    <span style={{
      padding: "2px 9px", borderRadius: 7, fontSize: 11,
  ...
  return (
    <a href={href} target="_blank" rel="noreferrer"
      ...
      style={{
        ...
        border: hov ? `1px solid ${color}40` : "1px solid rgba(255,255,255,0.07)",
        background: hov ? `${color}12` : "rgba(255,255,255,0.025)",
        color: hov ? color : "#475569", transition: "all .2s",
      }}>
...
function Navbar() {
  ...
  return (
    <header style={{
      ...
      background: scrolled ? "rgba(5,13,26,0.94)" : "transparent",
      backdropFilter: scrolled ? "blur(20px)" : "none",
      WebkitBackdropFilter: scrolled ? "blur(20px)" : "none",
      borderBottom: scrolled ? "1px solid rgba(255,255,255,0.05)" : "none",
    }}>
      <nav style={{ maxWidth: 1200, margin: "0 auto", padding: "0 28px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
        {/* Logo */}
        <a href="/" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <div style={{ width: 34, height: 34, borderRadius: 10, background: "linear-gradient(135deg,#00EEFF,#4F46E5)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <span className="te-mono" style={{ color: "#050D1A", fontWeight: 900, fontSize: 11 }}>TE</span>
          </div>
          <span className="te-display" style={{ fontWeight: 800, color: "white", fontSize: 18, letterSpacing: "-0.01em" }}>TechEra</span>
        </a>

        {/* Nav links */}
        <div style={{ display: "flex", gap: 2 }}>
          {[["Home", "/"], ["Team", "/team"], ["Events", "/events"], ["Collabs", "/collaborations"], ["Contact", "/contact"]].map(([label, href]) => (
            <a key={label} href={href} className={`te-nav-link${label === "Team" ? " active" : ""}`}>{label}</a>
          ))}
        </div>

        {/* CTA */}
        <a href="#join" className="te-btn" style={{ padding: "9px 20px", fontSize: 13 }}>Join Now</a>
      </nav>
    </header>
  );
}
...
function TeamHero() {
  ...
  return (
    <section style={{ position: "relative", minHeight: "100vh", display: "flex", alignItems: "center", overflow: "hidden", background: "#050D1A", paddingTop: 100, paddingBottom: 64, paddingLeft: 28, paddingRight: 28 }}>
      ...
      <div style={{ position: "relative", maxWidth: 1200, margin: "0 auto", width: "100%", display: "grid", gridTemplateColumns: "1fr auto", gap: 60, alignItems: "center" }}>
        ...
        <div>
          ...
          <h1 className="te-display te-fadeUp" style={{ fontSize: "clamp(38px,5.5vw,72px)", fontWeight: 800, lineHeight: 1.04, letterSpacing: "-0.03em", marginBottom: 24, animationDelay: "0.08s", opacity: 0 }}>
            <span style={{ color: "white" }}>People who</span>
            <br />
          ...
          <p className="te-fadeUp" style={{ color: "#64748B", fontSize: "clamp(15px,1.6vw,18px)", lineHeight: 1.75, maxWidth: 540, marginBottom: 40, animationDelay: "0.15s", opacity: 0 }}>
          ...
          <div className="te-fadeUp" style={{ display: "flex", gap: 36, flexWrap: "wrap", animationDelay: "0.22s", opacity: 0 }}>
            {[
              ...
              <div key={i}>
                ...
                <div style={{ fontSize: 11, color: "#475569", marginTop: 5, textTransform: "uppercase", letterSpacing: "0.1em" }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", flexShrink: 0 }}>
          <div style={{ position: "relative", width: 230, height: 230 }}>
            ...
            {orbitIcons.map((icon, i) => {
              ...
              return (
                <div key={i} style={{
                  position: "absolute", top: "50%", left: "50%", width: 36, height: 36, borderRadius: 11,
                  background: "rgba(10,22,40,0.92)", border: "1px solid rgba(0,238,255,0.14)",
                  display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15,
                  transform: `translate(-50%,-50%) translate(${Math.cos(angle) * r}px,${Math.sin(angle) * r}px)`,
                  animation: `te-float ${3 + i * 0.5}s ease-in-out infinite`,
  ...
  return (
    <article className="te-card-lift" onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{
        ...
        border: hov ? `1px solid ${founder.color}2e` : "1px solid rgba(255,255,255,0.06)",
        boxShadow: hov ? `0 24px 60px rgba(0,0,0,0.5), 0 0 48px ${founder.color}08` : "none",
      }}>
      ...
      <div style={{ padding: 28, position: "relative" }}>
        ...
        <p style={{ color: "#64748B", fontSize: 13.5, lineHeight: 1.65, marginBottom: 18 }}>{founder.bio}</p>
  ...
  return (
    <div className="te-card-lift" onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{
        ...
        border: hov ? `1px solid ${color}2e` : "1px solid rgba(255,255,255,0.06)",
        boxShadow: hov ? `0 16px 50px rgba(0,0,0,0.4), 0 0 30px ${color}06` : "none",
        padding: 24,
      }}>
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)}
      style={{
        ...
        borderRadius: 14, cursor: "default", transition: "all .22s",
        border: hov ? `1px solid ${color}25` : "1px solid rgba(255,255,255,0.05)",
      ...
      <div>
        <div style={{ fontSize: 13.5, fontWeight: 600, color: hov ? "white" : "#CBD5E1", transition: "color .2s" }}>{member.name}</div>
        <div style={{ fontSize: 11, color: "#475569", marginTop: 1 }}>{member.role}</div>
      </div>
    </div>
  );
}
...
function DepartmentBlock({ dept }) {
  ...
  return (
    <div style={{ marginBottom: 52 }}>
      {/* Dept header card */}
      <div style={{
        position: "relative", borderRadius: 20, padding: "26px 30px", marginBottom: 24,
        border: "1px solid rgba(255,255,255,0.05)", overflow: "hidden",
        background: dept.gradient, transition: "border-color .3s",
      }}>
        {/* animated scan line */}
        ...
        <div style={{ display: "flex", alignItems: "flex-start", gap: 18, position: "relative" }}>
          <div style={{ width: 52, height: 52, borderRadius: 16, background: `${dept.color}18`, border: `1.5px solid ${dept.color}2e`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 22, flexShrink: 0 }}>
            {dept.icon}
          </div>
          <div style={{ flex: 1 }}>
            ...
            <p style={{ color: "#64748B", fontSize: 13.5, lineHeight: 1.65 }}>{dept.description}</p>
          </div>
        </div>
      </div>
        ...
        <>
          ...
          {extra > 0 && (
            <button onClick={() => setExpanded(!expanded)} style={{
              marginTop: 12, padding: "7px 16px", borderRadius: 10, cursor: "pointer",
              border: `1px solid ${dept.color}25`, background: `${dept.color}08`,
              color: dept.color, fontSize: 12, fontWeight: 700,
              fontFamily: "'JetBrains Mono',monospace", transition: "background .2s",
...
function DepartmentsSection() {
  ...
  return (
    <section style={{ padding: "20px 28px 96px", position: "relative" }}>
...
function TeamCTA() {
  return (
    <section id="join" style={{ padding: "0 28px 100px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{
          position: "relative", borderRadius: 28, overflow: "hidden",
          border: "1px solid rgba(255,255,255,0.06)",
          background: "linear-gradient(135deg,rgba(79,70,229,0.12) 0%,rgba(10,22,40,0.92) 50%,rgba(0,238,255,0.08) 100%)",
        }}>
          <div className="te-dot-bg" style={{ position: "absolute", inset: 0, pointerEvents: "none" }} />

          {/* Corner brackets */}
          {[
            { pos: { top: 0, left: 0 },     bt: true,  bl: true,  br: "22px 0 0 0"   },
            { pos: { top: 0, right: 0 },    bt: true,  br_: true, br: "0 22px 0 0"   },
            { pos: { bottom: 0, left: 0 },  bb: true,  bl: true,  br: "0 0 0 22px"   },
            { pos: { bottom: 0, right: 0 }, bb: true,  br_: true, br: "0 0 22px 0"   },
          ].map(({ pos, bt, bl, br_, bb, br }, i) => (
            <div key={i} style={{
              position: "absolute", ...pos, width: 48, height: 48,
              borderTop:    bt  ? "1.5px solid rgba(0,238,255,0.15)" : undefined,
              borderBottom: bb  ? "1.5px solid rgba(0,238,255,0.15)" : undefined,
              borderLeft:   bl  ? "1.5px solid rgba(0,238,255,0.15)" : undefined,
              borderRight:  br_ ? "1.5px solid rgba(0,238,255,0.15)" : undefined,
              borderRadius: br,
            }} />
          ))}
          ...
          <div style={{ position: "relative", padding: "clamp(40px,6vw,72px) clamp(32px,5vw,56px)", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 32, flexWrap: "wrap" }}>
            <div>
              ...
              <p style={{ color: "#64748B", fontSize: 15, maxWidth: 480, lineHeight: 1.7 }}>
                We're always looking for passionate people. Pick a department, bring your skills, and help us build something meaningful.
              </p>
            </div>
            ...
            <div style={{ display: "flex", gap: 12, flexWrap: "wrap", flexShrink: 0 }}>
              ...
              <a href="#" style={{
                ...
                color: "#64748B", border: "1px solid rgba(255,255,255,0.08)", background: "rgba(255,255,255,0.03)",
...
function Footer() {
  return (
    <footer style={{ borderTop: "1px solid rgba(255,255,255,0.05)", padding: "32px 28px", textAlign: "center" }}>
      <p className="te-mono" style={{ color: "#1E3A5F", fontSize: 12 }}>
